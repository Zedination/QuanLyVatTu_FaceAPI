...
%>
	<c:redirect url="/alert"></c:redirect>
<%
	}
%>
  <title>Main</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="profile">
        ...
        <div class="sidebar-brand-text mx-3"><%=user.getFullName()%> <sup>2</sup></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="qldonhang">Đơn hàng</a>
            <a class="collapse-item" href="dmnhacc">Nhà cung cấp</a>
            <a class="collapse-item" href="tonkho">Tồn kho</a>
            <a class="collapse-item" href="qlphieunhap">Phiếu nhập</a>
            <a class="collapse-item" href="qlphieuxuat">Phiếu xuất</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
          ...
          <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="login">Đăng nhập</a>
              <a class="collapse-item" href="Signup">Đăng ký</a>
              <a class="collapse-item" href="doimatkhau">Đổi mật khẩu</a>
              <a class="collapse-item" href="forgot-password">Quên mật khẩu</a>
...
<!-- Nav Item - Game Collapse Menu -->
      <li class="nav-item">
        ...
        <div id="collapse" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Game HTML5:</h6>
            <a class="collapse-item" href="2048">2048</a>
            <a class="collapse-item" href="floppybird">Floppybird</a>
            <a class="collapse-item" href=munder>Munder kill or be killed</a>
            <a class="collapse-item" href="trap-adventure-2">Trap Adventures 2</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content" class="bg-light">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <!-- Dropdown - Alerts -->
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in bg-white" aria-labelledby="alertsDropdown">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <!-- Dropdown - Messages -->
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in bg-white" aria-labelledby="messagesDropdown">
                <h6 class="dropdown-header">
                  Message Center
                </h6>
                <a class="dropdown-item d-flex align-items-center" href="#">
       ...
       <div class="container-fluid ">
          ...
          <!-- Page Heading -->
          <!-- <h3 class="h3 mb-4 text-gray-800">Trang chủ</h3> -->
          <h3 style="text-align: center;">Đổi Mật Khẩu</h3>
          <br>
          <br>
			<div style = "margin-bottom: 20px; text-align: center">
			Cho tài khoản "<%=user.getUsername()%>"
			</div>

          <div class="row">
            <div class="col-md-3"></div>
            <div class="col-md-6">
              <form action = "doimatkhau" onsubmit="return validateForm()" method="POST">
                <div class="form-group" >
                  <input type="password" class="form-control form-control-user" id="oldPass" name = "oldPass" placeholder="Nhập mật khẩu cũ...">
                  <br>
                  <input type="password" class="form-control form-control-user" id="newPass0"  placeholder="Nhập mật khẩu mới...">
                  <br>
                  <input type="password" class="form-control form-control-user" id="newPass1" name = "newPass" placeholder="Nhập lại mật khẩu mới...">
                </div>
        ...
        <script>
          function validateForm() {
            ...
            var y = document.getElementById("newPass0").value;
            var z = document.getElementById("newPass1").value;
              if (x == ""||y==""||z=="") {
              alert("Không được để trống bất kỳ trường nào phía dưới");
              return false;
              }else if(y!==z){
                alert("Mật khẩu mới và mật khẩu xác thực không được khác nhau");
                return false;
              }
