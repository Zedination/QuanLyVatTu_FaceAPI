      ...
      <div id="content" class="bg-light">
       ...
       <div class="container-fluid ">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
             	<Strong style="text-align: center;">Tên đăng nhập: <%=user.getUsername()%></Strong>
          <br>
          <Strong style="text-align: center;">Tên đầy đủ: <%=user.getFullName()%></Strong>
          <br>
          <Strong style="text-align: center;">Email liên hệ: <%=user.getEmail()%></Strong>
          <br>
