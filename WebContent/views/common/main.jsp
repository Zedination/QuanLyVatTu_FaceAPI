      ...
      <div id="content" class="bg-light">
        ...
        <div class="container-fluid">
          ...
          <h2 class="h3 mb-4 text-gray-800">Hệ thống quản lý vật tư xây dựng bởi Lê Anh Đức</h2> -->
			<h3 style="text-align: center;">Trang chủ</h3>
          <h3 style="text-align: center;">Hệ thống quản lý vật tư xây dựng bởi Lê Anh Đức</h3>
          <br>
          <br>
          <br>
          <p>Các bạn có thể download slide hướng dẫn <a href="download-slide">tại đây!</a></p>
          <p>Các bạn có thể download source code project này của tôi <a href="download-guide">tại đây!</a></p>
          <p>Demo điểm danh bằng nhận diện khuôn mặt <a href="diemdanh">tại đây!</a></p>
          <p>Demo so sánh mặt người <a href="verify">tại đây!</a></p>
        </div>
        <!-- /.container-fluid -->
