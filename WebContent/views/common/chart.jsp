...
<!-- Nav Item - Game Collapse Menu -->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content" class="bg-light">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Biểu Đồ DEMO từ dữ liệu tĩnh sử dụng Chart.js</h1>
  ...
  <script src="<c:url value="/resources/bs4css/dark-mode-switch.min.js"/>"></script>
    <!-- Page level plugins -->
  <script src="<c:url value="/resources/bs4/vendor/chart.js/Chart.min.js"/>"></script>

  <!-- Page level custom scripts -->
  <script src="<c:url value="/resources/bs4/js/demo/chart-area-demo.js"/>"></script>
  <script src="<c:url value="/resources/bs4/js/demo/chart-pie-demo.js"/>"></script>
  <script src="<c:url value="/resources/bs4/js/demo/chart-bar-demo.js"/>"></script>
</body>
